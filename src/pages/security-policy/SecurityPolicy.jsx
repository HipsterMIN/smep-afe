...
export default function SecurityPolicy() {
  ...
  //         ...row,
  //         rowNumber: merged.length - idx, // 순번 추가
  //       }));
  //     });
  //
  ...
  //
  //       // 만약 useYn이 'Y'인 데이터가 있다면 상단 폼에 채우기
  //       if (activePolicy) {
  //         setCreateParams({
  ...
  //           scrtyPlcyCd: activePolicy.scrtyPlcyCd || '',
  //         });
  //       }
  //     }
  //
  ...
  //   try {
  //     const res = await http.get('/api/v1/security-policies/count', {
  ...
  //   //유효성 검사
  //   // if (!createParams.scrtyPlcyCd.trim()) {
  //   //   alert('보안정책코드는 필수입니다.');
  //   //   return;
  //   // }
  //   const sessVldHrCnt = Number(createParams.sessVldHrCnt) || 0;
  //
  //   if (sessVldHrCnt > 99) {
  //     alert('세션 유효시간은 99시간을 초과할 수 없습니다.');
  //     return;
  //   }
  ...
  //     return;
  //   }
  //   if (!String(createParams.sessVldHrCnt ?? '').trim()) {
  //     alert('세션유효시간수는 필수입니다.');
  //     return;
  //   }
  //
  //   if (!String(createParams.lgnMinCycDayCnt ?? '').trim()) {
  //     alert('로그인최소주기일수는 필수입니다.');
  //     return;
  //   }
  //
  //   if (!String(createParams.dpcnLgnChckCycMncnt ?? '').trim()) {
  //     alert('중복로그인체크주기분수는 필수입니다.');
  //     return;
  //   }
  //
  //   if (!String(createParams.pswdFailPrmNmtm ?? '').trim()) {
  //     alert('비밀번호실패허용횟수는 필수입니다.');
  //     return;
  //   }
  //
  //   if (!String(createParams.pswdExpiryWarnPrdDayCnt ?? '').trim()) {
  //     alert('비밀번호만료경고기간일수는 필수입니다.');
  //     return;
  //   }
  //
  //   if (!String(createParams.pswdVldPrdDayCnt ?? '').trim()) {
  //     alert('비밀번호유효기간일수는 필수입니다.');
  //     return;
  //   }
  //
  //   try {
