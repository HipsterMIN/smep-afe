...
export default function MenuBase({
  ...
  const handleDelete = async () => {
    ...
    if (
      !window.confirm(`${form.menuNm}(${form.menuId}) 을(를) 삭제하시겠습니까?`)
    )
      return;
  ...
  function rowTreeState(type) {
    apiRef.current?.exec(type ? 'open-row' : 'close-row', {
      id: 0,
      nested: true,
    });
  }
      ...
      <div className="oncontentTitle">
        ...
        <ul className="onbreadcrumb">
          {breadcrumb.map((b, i) => (
            <li
              key={i}
              className={i === breadcrumb.length - 1 ? 'on' : undefined}
            >
              {b}
            </li>
          ))}
        ...
        <div className="oncontent">
          ...
          <div className="ontable-legend">
            ...
            <div className="onbtns">
              <button
                className="onallopen-ico"
                type="button"
                onClick={() => rowTreeState(true)}
              />
              <button
                className="onallclose-ico"
                type="button"
                onClick={() => rowTreeState(false)}
              />
            </div>
          </div>
                      ...
                      <td>
                        <div className="onradioBox">
                          <RadioButton
                            ...
                            onChange={(v) =>
                              handleInputChange('upendMenuExpsrYn', v)
                            }
                          />
                          <RadioButton
                            groupId="5"
                      ...
                      <td>
                        <div className="onradioBox">
                          <RadioButton
                            ...
                            onChange={(v) =>
                              handleInputChange('lfsdMenuExpsrYn', v)
                            }
                          />
                          <RadioButton
                            groupId="7"
