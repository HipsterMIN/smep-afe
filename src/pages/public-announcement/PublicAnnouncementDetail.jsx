...
export default function PublicAnnouncementDetail({
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const existingNoticeFiles = (res.data?.pbancMtxtAtchFiles ?? []).map(
        mapExistingFile
      );
            ...
            <table>
              ...
              <tbody>
                <tr>
                  ...
                  <td>공개여부</td>
                  <td>
                    {renderReleaseStatusRadioGroup(
                      'linkInstBizPbancRlsSttsCd',
                      form.linkInstBizPbancRlsSttsCd
                    )}
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    <MenuInputBox
                      ...
                      onChange={(e) =>
                        handleInputChange('bizPbancSprtTypeCd', e)
                      }
                ...
                <tr>
                  ...
                  <td>
                    <MenuInputBox
                      ...
                      onChange={(e) =>
                        handleInputChange('bizPbancLinkInstCd', e)
                      }
                ...
                <tr>
                  ...
                  <td colSpan={3}>
                    <MenuInputBox
                      ...
                      onChange={(v) =>
                        handleInputChange('bizPbancInqplHmpgUrlAddr', v)
                      }
                    />
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <MenuInputBox
                      ...
                      onChange={(v) =>
                        handleInputChange('bizPbancInqplTkcgDeptNm', v)
                      }
                    />
                  </td>
                  <td>문의처 전화번호</td>
                  <td>
                    <MenuInputBox
                      ...
                      onChange={(v) =>
                        handleInputChange('bizPbancInqplTelnoCn', v)
                      }
                    />
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    <TextareaBox
                      ...
                      onChange={(v) =>
                        handleInputChange('bizSprtQlfcRqmtCn', v)
                      }
                    />
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <TextareaBox
                      ...
                      onChange={(v) =>
                        handleInputChange('bizAplyExclTrgtCn', v)
                      }
                    />
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    <TextareaBox
                      ...
                      onChange={(v) =>
                        handleInputChange('sprtQlfcEntTypeCn', v)
                      }
                    />
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <TextareaBox
                      ...
                      onChange={(v) =>
                        handleInputChange('bizPbancPrtrtMttrCn', v)
                      }
                    />
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <TextareaBox
                      ...
                      onChange={(v) =>
                        handleInputChange('bizPbancSprtAmtCn', v)
                      }
                    />
                  </td>
                </tr>
