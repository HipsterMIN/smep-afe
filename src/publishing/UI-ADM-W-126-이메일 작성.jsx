    ...
    <div className="oncontentbox full">
      ...
      <div className="oncontents">
            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  <td>제목</td>
                  <td colSpan={3}>
                    <MenuInputBox menuType="input" menuSize="100%" placeholder="제목을 입력해주세요." />
                  </td>
                </tr>
                <tr>
                  <td>발신자 정보</td>
                  <td>
                    <MenuInputBox menuType="input" menuSize="100%" placeholder="발신자명을 입력해주세요." />
                  </td>
                  <td>이메일 주소</td>
                  <td>
                    <MenuInputBox menuType="input" menuSize="100%" placeholder="이메일 주소를 입력해주세요." />
                  </td>
                </tr>
                <tr>
                  <td>수신자</td>
                  <td colSpan={3}>
                    <div className="flexColumn">
                      <div className="flexRow">
                        <MenuInputBox menuType="input" menuSize="150px" placeholder="이름을 입력하세요." />
                        <MenuInputBox menuType="input" menuSize="300px" placeholder="이메일 주소를 입력해주세요." />
                ...
                <tr>
                  ...
                  <td colSpan={3}>
                    <div className="flexRow">
                      ...
                      <div className="ondatepickerbox" style={{ marginLeft : '10px' }}>
                        <DatepickerBox />
                ...
                <tr>
                  ...
                  <td colSpan={3}><div className="oneditcontent"></div></td>
                </tr>
                <tr>
                  <td>설명</td>
                  <td colSpan={3}><div className="oneditcontent"></div></td>
        ...
        <div className="onflexbtns">
          ...
          <Button btnType="edit" btnNames="다시쓰기" />
